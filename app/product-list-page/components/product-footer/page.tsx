...
import ProductFooter2 from './product-footer-2/page'

function  ProductFooter() {
  return (
    <div className='md:w-[1300px] md:h-[488px] xs:w-[414px] xs:h-[1342px] xs:flex-col relative top-[120px]'>
        <div className='md:w-[1300px] h-[142px] xs:w-[414px] md:flex xs:flex-col relative'>
