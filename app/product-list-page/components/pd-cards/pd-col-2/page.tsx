    ...
    <div className='w-[1048px] h-[448px] flex gap-[30px] md:flex xs:hidden'>
      ...
      <div className='w-[238px] h-[448px]'>
       ...
       <div className='w-[238px] h-[448px]'>
             ...
             {/* Image 7*/}
      <div className='w-[238px] h-[448px]'>
              <Image src={'/image/pd-7.svg'}
              alt='Product Image 7 for pages'
              width={238}
              height={300}>
              </Image>
              <div className='w-[239px] h-[188px] px-[25px] pt-[25px] pb-[35px] flex-col 
       ...
       {/* Image 8 */}
       <div className='w-[238px] h-[448px]'>
              <Image src={'/image/pd-8.svg'}
              alt='Product Image 8 for pages'
              width={238}
              height={300}>
              </Image>
              <div className='w-[239px] h-[188px] px-[25px] pt-[25px] pb-[35px] flex-col 
