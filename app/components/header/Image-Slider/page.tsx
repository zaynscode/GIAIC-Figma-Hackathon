  ...
  return (
    ...
    xs:top-[550px] left-[1px] rounded-[5px] border-[1px] border-[#DEDEDE]'>
        ...
        className='xs:flex md:hidden object-cover'>
            ...
            <div className='md:w-[1044px] md:h-[651px] xs:w-[414px] xs:h-[705px] absolute top-12
             justify-items-center md:left-[197.5px] py-28 flex-col flex gap-20'>
            <div className='md:w-[1044px] md:h-[457px] xs:w-[419px] xs:h-[560px] py-12 grid gap-5
            xs:gap-[30px]'>
                <div className='w-[599px] md:h-[331px] xs:h-[381px] flex-col xs:gap-[35px] grid md:gap-[20px]
                '>
