...
function Footer() {
  return (
    <div className='md:w-[1300px] md:h-[488px] xs:w-[414px] xs:h-[1342px] xs:flex-col'>
        <div className='md:w-[1300px] h-[142px] xs:w-[414px] md:flex xs:flex-col relative bg-[#FAFAFA] '>
