...
function ShopRow() {
  return (
    <div className='md:w-[1050px] md:h-[500px] relative pl-[38px] md:pl-0 md:left-0 xs:h-[1560px] md:flex-row
     xs:flex-col flex gap-[30px]'>
        {/* Men section */}
        <div className='md:w-[510px] h-[500px] relative'> 
