...
function ShopCards() {
  return (
    <div className='md:w-[1440px] xs:w-[414px] xs:h-[1850px] md:h-[770px] bg-[#FAFAFA] '>
        ...
        xs:left-[40.5px] py-20 flex-col grid gap-12 '>
            <div className='md:w-[607px] md:h-[62px] xs:w-[333px] xs:h-[82px] justify-self-center'>
                <div className='w-[607px] md:h-[62px] xs:h-[82px] gap-[10px] flex flex-col 
               absolute xs:left-[50px] md:left-[400px] justify-items-center '>
                    ...
                    text-sm text-center text-[#737373] tracking-[0.2px] relative left-[-70px]'>
