...
function FeaturedCard1() {
  return (
      <div className='w-[328px] h-[606px] '>
            {/* First Image */}
            <div className='md:w-[348px] xs:w-[330px] h-[300px] relative'>
                <Image src={'/image/featured-post-1.svg'}
                alt='Featured Post 1'
                width={348}
                height={300}
                className='object-cover xs:hidden md:flex'></Image>
                {/* mobile image 1 */}
                <Image src={'/image/featured-post-1-m.svg'}
                alt='Featured Post 1 for mobile'
                width={348}
                height={300}
