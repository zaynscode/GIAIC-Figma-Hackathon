...
function ContactHeader() {
  return (
    <div className='md:w-[1340px] md:h-[882px] xs:h-[532px] xs:bg-[#FAFAFA] md:bg-white'>
        ...
        <div className='md:w-[1280px] md:h-[91px] relative md:left-[60px] '>
            ...
            md:bottom-[20px] '>
                ...
                '>
                    ...
                    xs:left-[7px] md:left-0 hover:text-[#23A6F0] duration-500'>Home
                    </h1>
                    </Link>
                    ...
                    xs:text-[30px] xs:leading-[45px] text-center hover:text-[#23A6F0] duration-500'>Product
                    </h1>
                    <Link href={'/pricing-page'}>
                    <h1 className='md:w-[52px] md:h-6 xs:w-[107px] xs:h-[45px] font-montserrat md:font-bold
                    xs:font-normal text-[#737373] md:text-[14px] md:leading-6 tracking-[0.2px] 
                    xs:text-[30px] xs:leading-[45px] text-center hover:text-[#23A6F0] duration-500'>
                        Pricing
                    </h1>
                        </Link>
